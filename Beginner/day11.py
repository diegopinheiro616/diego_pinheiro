...
def play_game():
    ...
    for _ in range(2):  # <---- uma das variáveis não importa. O importante é rodar duas vezes.
        user_cards.append(deal_card())  # += ou extend só pode ser usado para adicionar lists, não um item só.
